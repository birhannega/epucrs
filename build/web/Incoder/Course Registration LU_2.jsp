            ...
            <div class="span12">
                ...
                <div class="col-lg-10">
                    <div class="col-lg-12">
                        ...
                        <button class="btn-primary pull-right" data-toggle="modal" data-target="#mymodalAddCourse">Add Course</button>
                        <div class="modal" id="mymodalAddCourse">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <h5 class="align-center">To Register a new Course </h5>
                                    </div>
                                    <!--end of header-->
                                    <!--start body modal-->
                                    <div class="modal-body">
                                        <form class="form-group " method="post" id="stud_reg" action="">
                                            ...
                                            <div class="form-group col-lg-12" > 
                                                ...
                                                <div class="container col-lg-3"> <button type="close" class="btn navbar-btn btn-info" data-dismiss="modal">Clear</button></div>
                                                <div class="form-group col-lg-6">    </div>
                                            </div>
                        ...
                        <form class="form-group " method="post" id="stud_reg" action="">
                            ...
                            <div class="container">
                                <h1>datatable</h1>
                                <table class="table table-striped table-bordered table-hover" width="100%" cellspacing="0" id="tabledate">
                                    <thead>
                                        <tr>
                                            <th>Term</th>
                                            <th>Subject</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>2011/04/25</td>
                                            <td>YES</td>
                                            <td><button class="btn-warning" id="btnedit">Edit</button> <button class="btn-danger" id="btndelete">Delete</button></td>
                                        </tr>
                                        <tr>
                                            <td>Term2</td>
                                            <td>Law</td>
