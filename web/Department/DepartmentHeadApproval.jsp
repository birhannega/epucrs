...
<form method="post"action="${pageContext.request.contextPath}/programmanager_approval" 
               id="mark" name="mark" onsubmit="return valiatemark(this)">
         ${inserted}
             <h4 class="text-center">Department Head  Mark Approval Form</h4>
...
<input type="text"  class="form-control" value="<%=module_title%>" readonly="readonly">
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        Term<input type="text" class="form-control" value="<%=term%>" disabled> 
                            ...
                            <div class="form-group col-lg-4">
                                <%-- Department Head id get from session --%>
                        Department Head Name <input type="text" class="form-control" value="" name="departmentheadname">
                    </div>
                        <div class="form-group col-lg-4">
        ...
        <tbody>
         ...
         ResultSet rs_student=st_student.executeQuery("select * from TBL_STUDENT_PROFILE,tbl_mark where tbl_mark.stud_id=TBL_STUDENT_PROFILE.stud_id and status=1");
               ...
               <input  type="hidden"value="<%=course%>"> 
                ...
                <td><%=mark_100%></td><input type="hidden"  value="<%=mark_100%>">
                 ...
                 <input  type="hidden" value="<%=term%>">
                    <input name="departmenthead" type="hidden" value="seid">
