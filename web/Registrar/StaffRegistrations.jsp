...
<html>
    <head>
        <title>Registrar staff registration</title>
            ...
            <div class="side-body">
                <div class="container-fluid">
                    ...
                    <ul class="nav nav-tabs" id="myTab">
                        ...
                        <li><a data-toggle="tab" href="#sectionC"><span class="glyphicon glyphicon-user glyphicon-camera"></span>Edit Photo<span class="glyphicon glyphicon-user glyphicon-pencil"></span></a></li>

                        <li><a data-toggle="tab" href="#sectionD"><span class="glyphicon glyphicon-user glyphicon-user"></span>Add Experiance<span class="glyphicon glyphicon-user glyphicon-check"></span></a></li>
