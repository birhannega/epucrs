        ...
        <div class="row">
                ...
                <nav class="navbar navbar-default" role="navigation">
                    ...
                    <div class="side-menu-container">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="Adduser.jsp"><span class="fa fa-plus-circle"></span> Add user</a></li>
                            <li class="active"><a href="history.jsp"><span class="glyphicon glyphicon-list-alt"></span> Academic year</a></li>
            ...
            <div class="container-fluid">
                <div class="side-body">
                    ...
                    <%@include file="markvalidationform.jsp" %>
