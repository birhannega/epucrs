...
<form method="post"action="${pageContext.request.contextPath}/programmanager_approval"id="mark" name="mark" onsubmit="return valiatemark(this)">
    <p class="pull-right">${updated} ${notupdated}</p>
       ...
       String program_manager_name="seid",activeyear=null;
      ...
      <div class="span12">
            <div class="col-lg-2" id="sidebar">
                <%@include file="../common/sidebar.jsp" %>
                    ...
                    <div class="form-group col-lg-4">
                        Approval Name <input type="text" class="form-control" value="<%=program_manager_name%>" >
                    </div>
...
$(document).ready(function() {
    $('#table_view').DataTable();
					...
					<tbody>
                                            ...
                                            ResultSet rs_student_mark=st_student_mark.executeQuery("select  Distinct stud_id, MARK_40 from tbl_mark where STATUS='1' and stud_id='"+studid+"'");
                                            ...
                                            ResultSet rs_student_mark_project=st_student_mark_project.executeQuery("select  Distinct stud_id , mark_60 from tbl_mark where STATUS='1'and stud_id='"+studid+"'");
                                     ...
                                     Statement st_student_mark_final=connection.getconnection().createStatement();
                                            ResultSet rs_student_mark_final=st_student_mark_final.executeQuery("select  Distinct stud_id , total from tbl_mark where status='1'and stud_id='"+studid+"'");
