            ...
            <div class="container-fluid">
                <div class="side-body">
                    ...
                    <ul class="nav nav-tabs" id="myTab">
                        ...
                        <li><a data-toggle="tab" href="#sectionC">EditPhoto</a></li>

                        <li><a data-toggle="tab" href="#sectionD">AddExperiance</a></li>
...
//                                                    Statement st_program = dbconnection.getconnection().createStatement();
                        ...
                        <div id="sectionC" class="tab-pane fade">
                            ...
                            <form class="form-group">
                                ...
                                <div class="col-lg-8"><label>Search By ID:</label> 
                                    <input type="text" name="imagename" id="imagename" placeholder="Enter Stud ID!">
                                    <input type="submit" value="search"/></div>
                                    <%
                                        String sid = request.getParameter("imagename");
                                        if (sid == null || sid == "") {
                         ...
                         %>
                           ...
                           <form class="form-group" method="POST" enctype="multipart/form-data" action="${pageContext.request.contextPath}//UpdatestaffImage">
                               ...
                               <input type="hidden" name="displayimageid" id="displayimageid" value="<%=request.getParameter("imagename")%>">
...
<!--                    </div>-->
                    ...
                    <div id="sectionD" class="tab-pane fade">
                        ...
                        <%
                            if (request.getParameter("action") != null && request.getParameter("id") != null) {
                                ...
                                if (action.equalsIgnoreCase("delete")) {
                                    //Alert="";
                                    ResultSet rs_delete_update = stmt.executeQuery("delete from TBL_ACADEMIC_EXPERTISE where ACADEMIC_STAFF_ID='" + id + "'");
                                    //                                if (rs_delete_update.next()) {
                        ...
                        <% } else if (action.equalsIgnoreCase("edit")) {
                            ...
                            ResultSet rs_update = stmt.executeQuery("select * from TBL_ACADEMIC_EXPERTISE where ACADEMIC_STAFF_ID='" + id + "'");
                            if (rs_update.next()) {
                                ...
                                <table  class="table table-striped table-bordered table-hover "  id="tabledata1">
                                    ...
                                    <tbody>
                                        <%
                                            //                                        connectionManager dbconnection = new connectionManager();
                                            //                                        Statement st_list_course = dbconnection.getconnection().createStatement();
                                            String crs_sql = "select ACADEMIC_STAFF_ID,AREA_EXPERTISE,ORG_TYPE,ORG_NAME,TOTAL_EXPERTISE,DATE_FROM,DATE_TO from TBL_ACADEMIC_EXPERTISE ";
                ...
                <!--                            <td><%=_acdstaff.getString(1)%></td> -->
                                            ...
                                            <td>
                                                <form action="" method="post">
                                                    <input type="hidden" name="action" value="edit"/>
                                                    <input type="hidden" name="id" id="edit_id" value="<%=_acdstaff.getString(1)%>"/>
                                            ...
                                            <td>
                                                <form action="" class="form-group" method="Post" >
                                                    <input type="hidden" name="action" value="delete"/>
                                                    <input type="hidden" name="id" id="delete_id" value="<%=_acdstaff.getString(1)%>"/>
