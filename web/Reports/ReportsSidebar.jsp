    ...
    <li class="panel panel-primary" id="dropdown">
       ...
       <li class="panel panel-primary" id="dropdown">
        <a data-toggle="collapse" href="#dropdown-lvl4">
            <span class="glyphicon glyphicon-book"></span> Course Report  <span class="caret"></span>
        </a>
        <!-- Dropdown level 1 -->
        ...
        <a data-toggle="collapse" href="#dropdown-lvl5">
            <span class="glyphicon glyphicon-book"></span> Student Report  <span class="caret"></span>
        </a>
        <!-- Dropdown level 1 -->
        <div id="dropdown-lvl5" class="panel-collapse collapse">
            <div class="panel-body">
                 <ul class="nav navbar-nav">
                   <!--<li><a href="ClassRegistration.jsp"><span class="glyphicon glyphicon-print"></span> Class Registration</a></li>-->
                    <li><a href="TermReport.jsp"><span class="glyphicon glyphicon-retweet"></span> Registrar Report </a></li>
                     <!--<li><a href="ClassRegistration.jsp"><span class="glyphicon glyphicon-retweet"></span> Class Re-Assignment </a></li>-->
                </ul>
            </div>
        </div>
