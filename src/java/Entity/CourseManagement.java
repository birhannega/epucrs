...
public class CourseManagement {
    ...
    public int registerCourse(String id,String term,String name,String date,String subject,String creditHr,String prerequest) throws SQLException, ClassNotFoundException
    {
        int action=0;
            ...
            PreparedStatement ps_register=connection.getconnection().prepareStatement("INSERT INTO TBL_COURSE_REGISTRATION (COURSE_CODE,TERM, COURSE_NAME, CREDIT_HOURS, REGISTRATION_DATE, SUBJECT, COURSE_TYPE) VALUES(?,?,?,?,?,?,?)");
