...
public class Events {
    ...
    public int Editeventschedule(String edited_title, String edited_name, String edited_start_date, String edited_end_date, int id) throws SQLException {
        int edited_value;
        ...
        ps_edit.setString(3, edited_start_date);
        ps_edit.setString(4, edited_end_date);
        ps_edit.setInt(5, id);
