...
//        prestm.setString(10, insttype);
//        prestm.setString(11, responsibility);
//        prestm.setString(12, hireddate);
//        prestm.setString(13, policemngmt);
...
//update expriance
    ...
    public int UpdateStaffExp(String staffid, String expid, String expctgry, String exptype, String orgname, String totalexp, String datefrom_exp_from, String datefrom_exp_to,String qualification,String seqno) throws SQLException, ClassNotFoundException {
        ...
        connectionManager cm = new connectionManager();
        Connection con = cm.getconnection();
        PreparedStatement prestm = con.prepareStatement("UPDATE TBL_ACADEMIC_EXPERTISE set ACADEMIC_STAFF_ID=?,INSTEXP_ID=? ,AREA_EXPERTISE=? ,ORG_TYPE=?, ORG_NAME=?  ,"
