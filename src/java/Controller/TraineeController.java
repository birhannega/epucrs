...
public class TraineeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String birt_date=request.getParameter("bdate"),department=request.getParameter("dpt"),end_date=request.getParameter("end_date"),
                   firstname=request.getParameter("firstname"),lastname=request.getParameter("latsname"),middlename=request.getParameter("middlename"),
                   phone=request.getParameter("tel"),title=request.getParameter("title");
                 TraineeManagment trainee_reg=new TraineeManagment();
            try {
                int traineeragistration=trainee_reg.Trainee_reg(birt_date, department, end_date, firstname, lastname, middlename, phone, birt_date, title);
