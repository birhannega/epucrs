 ...
 * @author user
 */
@WebServlet(name = "Pre_requestRegServlet", urlPatterns = {"/Pre_requestRegServlet"})
public class Pre_requestRegServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      String   crscode=request.getParameter("precrscode"),
              prerequestname=request.getParameter("prerequestname");
        CourseManagement crsmngmt=new CourseManagement();
        int prerequestsave=crsmngmt.AddPrerequest(crscode, prerequestname);
 if (prerequestsave > 0) {
...
//             out.println("course not registred");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Pre_requestRegServlet.class.getName()).log(Level.SEVERE, null, ex);
