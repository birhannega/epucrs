 ...
 * @author user
 */
@WebServlet(name = "CreditHourServlet", urlPatterns = {"/CreditHourServlet"})
public class CreditHourServlet extends HttpServlet {
...
//             out.println("course not registred");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CreditHourServlet.class.getName()).log(Level.SEVERE, null, ex);
