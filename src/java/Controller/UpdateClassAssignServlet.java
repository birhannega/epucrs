 ...
 * @author user
 */
@WebServlet(name = "UpdateClassAssignServlet", urlPatterns = {"/UpdateClassAssignServlet"})
public class UpdateClassAssignServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     String classassignid=classid.concat("01");
...
//     String classID=classlist.concat("01");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
             ...
             Logger.getLogger(UpdateClassAssignServlet.class.getName()).log(Level.SEVERE, null, ex);
